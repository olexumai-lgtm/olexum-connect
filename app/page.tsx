...
const OLEXUM_LOGO = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663309562810/gSByMzFOzKdTnjZW.png";
      ...
      <div style={styles.container}>
        ...
        <div style={styles.card}>
          <div style={styles.cardHeader}>
            ...
            <p style={styles.subtitle}>Confirm both steps below so we can bring your AI agent online.</p>
          </div>
